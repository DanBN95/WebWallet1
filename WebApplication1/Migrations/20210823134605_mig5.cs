        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FuturePaymentesListId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountFuturePayment", x => new { x.AccountsListId, x.FuturePaymentesListId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountFuturePayment_FuturePayment_FuturePaymentesListId",
                        column: x => x.FuturePaymentesListId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountFuturePayment_FuturePaymentesListId",
                table: "AccountFuturePayment",
                column: "FuturePaymentesListId");
